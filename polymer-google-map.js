...
// Wrap every asynchronus bower command with `Meteor._wrapAsync`
  ...
  if (!_.contains(localCache, 'GoogleWebComponents/google-map#^1.0.0')){
    console.log('installing polymer and google-map' +
        ' into public directory...');
    //console.log(localCache);
    Bower.install(['GoogleWebComponents/google-map#^1.0.0'], {save: true}, {directory: dir});
  } else {
    console.log("google-map exists already. To reinitialize, remove bower_components from your public/ folder");
  }
}